...
//                            tdrAutoTestLong();
    ...
    private void displayWave() {
        if (densityMax == 1) {
            ...
            operationFragment.btnZoomIn.setImageResource(R.drawable.bg_zoom1_selector);//jk20210130cs
        }
        if (mode == SIM) {
            if (isDatabase) {
...
//        tvDistance.setText(new DecimalFormat("0.00").format(distance) + "m");
    ...
    private void breakPointCalculate() {
        ...
        //实光标位置
        breakBk = breakBk + start + faultResult + 10;       //GT20220520
    }
...
//        Log.e("SIM筛选3", " /d1 = " + d1 + " /d2 = " + d2 + " /d3 = " + d3);
    ...
    private void switchDensity() {
        ...
        //默认显示滚动条
        operationFragment.btnZoomOut.setEnabled(true);//jk20210126
