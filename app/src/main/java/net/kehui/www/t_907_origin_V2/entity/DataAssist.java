...
import net.kehui.www.t_907_origin_V2.util.DataConverters;
...
@Entity(tableName = "dataAssist", indices = {@Index({"date", "mode", "range", "line", "phase", "tester", "location"})})
