package net.kehui.www.t_907_origin_V2.adpter;
...
/**
 * @author Gong
 * @date 2023/6/29  //协助记录数据库添加：适配器   //GC20230629
 */
public class RecordsAssistAdapter extends RecyclerView.Adapter {

    private OnItemClickListener onItemClickListener;
    private OnItemInitDataListener onItemInitDataListener;

    public List<DataAssist> datas = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        DataAssist data = datas.get(position);
